...
import UpdateApartment from "../modals/apartmentModal/UpdateApartment";
import CreatePost from "../modals/postModal/CreatePost";
    ...
    <>
      ...
      <div className="card table_container">
        <div className="table__header">
          {/* <h3 className="title">Floor : {data[0].level}</h3> */}
