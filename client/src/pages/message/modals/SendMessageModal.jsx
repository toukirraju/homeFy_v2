...
const SendMessageModal = ({ modalOpened, setModalOpened, ownerUsername }) => {
  const navigate = useNavigate();
  const dispatch = useDispatch();
  const [to, setTo] = useState(ownerUsername);
    ...
    >
      <div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <button
              className=" relative flex w-full justify-center rounded-md border border-transparent  px-4 py-2 text-sm font-medium  text-white bg-violet-600 hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 disabled:bg-slate-400"
              disabled={
